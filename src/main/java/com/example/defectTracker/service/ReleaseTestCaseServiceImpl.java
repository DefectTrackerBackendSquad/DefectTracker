...
import com.example.defectTracker.repository.UserRepo;
import com.example.defectTracker.repository.TestCaseRepo;
import com.example.defectTracker.repository.ReleasesRepo;
import com.example.defectTracker.exceptionHandler.ReleaseTestCaseBadRequestException;
import com.example.defectTracker.exceptionHandler.ReleaseTestCaseNotFoundException;
...
public class ReleaseTestCaseServiceImpl implements ReleaseTestCaseService {
    ...
    public ReleaseTestCase updateReleaseTestCase(Long id, ReleaseTestCaseDto dto) {
        ...
        // Validate testTime format (HH:mm:ss)
        ...
        // Check if ReleaseTestCase exists
        ...
        if (dto.getReleasesId() != null) {
            Releases releases = releasesRepo.findById(dto.getReleasesId()).orElse(null);
